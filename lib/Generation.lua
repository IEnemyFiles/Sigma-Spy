...
--// Module
local Generation = {
	DumpBaseName = "EnemySagaSpy-Dump %s.lua", -- "-- Generated with EnemySaga Spy BOIIIIIIIII (+9999999 AURA)\n"
	Header = "-- Generated with EnemySaga Spy Github: https://github.com/depthso/Sigma-Spy\n",
	ScriptTemplates = {
		["Remote"] = {
			{"%RemoteCall%"}
		},
